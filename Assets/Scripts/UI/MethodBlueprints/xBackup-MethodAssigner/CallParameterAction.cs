...
namespace UI.MethodBlueprints
{
    public abstract class CallParameterAction<T> : MethodBlueprint<Action<T>>
    {
        ...
        //Selectitem and Recruit both have special implementations of this but method gets called in base class
        ...
        {
            button.OnClickNoParams += () => GetMethod(methodProvider).Invoke(parameters[button]);
        }
    }
}